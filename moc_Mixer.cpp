...
**
** Created: Sat 5. Jan 20:08:59 2013
...
static const char qt_meta_stringdata_Mixer[] = {
    "Mixer\0\0startProcess()\0stopProcess()\0"
};
...
const QMetaObjectExtraData Mixer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Mixer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Mixer,
      qt_meta_data_Mixer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Mixer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Mixer))
