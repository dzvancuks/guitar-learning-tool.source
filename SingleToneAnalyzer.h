...
class SingleToneAnalyzer : public QThread {
    Q_OBJECT
public:
    ...
    */
    ...
    static const char* noteName(int pitch) { return noteNames[cycle(pitch, 12)]; } // as for pitch = 1 => A
...
private:
    ...
    */
    ...
    static __inline int cycle(const int a, const int b)
    {
        if(a >= 0) return a % b;
